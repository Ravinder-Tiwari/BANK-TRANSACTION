...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent flex">
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md glass p-8 rounded-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2">Join BankSys and manage your finances</p>
          </div>
      ...
      <div className="flex-1 hidden lg:flex items-center justify-center relative overflow-hidden bg-gradient-to-bl from-transparent to-primary/10">
        ...
        <div className="z-10 text-center space-y-6">
          ...
          <h1 className="text-5xl font-bold text-white tracking-tight">Start Your Journey</h1>
